...
# Script: debug-deposit-error.ps1
...
# Try deposit with manual values to catch exact error
$accId = 2
$depositData = @{
    transactionDate = (Get-Date).AddDays(-1).ToString("dd MMMM yyyy", [System.Globalization.CultureInfo]::InvariantCulture)
...
try {
    Write-Host "Trying deposit for Account 1..."
