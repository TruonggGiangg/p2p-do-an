...
# Script: test-client-accounts.ps1
...
Write-Host "--- FETCHING ACCOUNTS FOR CLIENT 5 ---"
$resp = Invoke-WebRequest -Uri "$fineractBaseUrl/clients/5/accounts" -Method Get -Headers $headers -UseBasicParsing
$resp.Content
