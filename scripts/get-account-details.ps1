...
# Script: get-account-details.ps1
...
Write-Host "--- ACCOUNT 2 DETAILS ---"
$resp = Invoke-WebRequest -Uri "$fineractBaseUrl/savingsaccounts/2" -Method Get -Headers $headers -UseBasicParsing
$resp.Content
