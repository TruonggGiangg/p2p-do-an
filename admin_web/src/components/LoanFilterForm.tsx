        ...
        <Form form={form} layout="vertical" onFinish={handleFinish}>
            <Row gutter={[16, 8]}>
                ...
                {(activeTab === 'overdue' || activeTab === 'all') && (
                    <>
                        <Col xs={24} sm={12} md={6}>
                            <Form.Item name="delinquentDaysMin" label="Số ngày quá hạn (từ)">
                                <InputNumber min={0} placeholder="Từ" style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={12} md={6}>
                            <Form.Item name="delinquentDaysMax" label="Số ngày quá hạn (đến)">
                                <InputNumber min={0} placeholder="Đến" style={{ width: '100%' }} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={12} md={6}>
                            <Form.Item name="minOverdueAmount" label="Khoản quá hạn từ (₫)">
                                <InputNumber min={0} placeholder="Từ" style={{ width: '100%' }} formatter={(v) => `${v}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')} />
                            </Form.Item>
                        </Col>
                        <Col xs={24} sm={12} md={6}>
                            <Form.Item name="maxOverdueAmount" label="Khoản quá hạn đến (₫)">
                ...
                <Col xs={24} sm={12} md={6}>
                    <Form.Item name="disbursementDate" label={dateLabel}>
