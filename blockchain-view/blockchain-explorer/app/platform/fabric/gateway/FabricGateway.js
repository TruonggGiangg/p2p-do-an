...
class FabricGateway {
    ...
    queryInstantiatedChaincodes(channelName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield contract.evaluateTransaction('QueryChaincodeDefinitions', '');
                ...
                logger.warn('_lifecycle query failed, trying lscc (Fabric 1.x)...', lifecycleError === null || lifecycleError === void 0 ? void 0 : lifecycleError.message);
                // Fallback to lscc for Fabric 1.x
                try {
                    const contract = network.getContract('lscc');
                    const result = yield contract.evaluateTransaction('GetChaincodes');
                    resultJson = fabprotos.protos.ChaincodeQueryResponse.decode(result);
                }
                catch (lsccError) {
                    logger.warn('lscc query also failed:', lsccError === null || lsccError === void 0 ? void 0 : lsccError.message);
    ...
    queryContractMetadata(channel_name, contract_name) {
        return __awaiter(this, void 0, void 0, function* () {
            const network = yield this.gateway.getNetwork(channel_name);
            // Get the contract from the network.Â  Â  Â  Â  
